...
function ns.RegisterSettings()
	...
	Settings.CreateDropdown(category, Register("marker", Settings.VarType.String, "Tooltip skill marker"), function()
		local container = Settings.CreateControlTextContainer()
		container:Add("rested", "Rested XP pip")
		container:Add("capture", "Capture bar arrow")
		container:Add("widget", "Widget bar marker")
		container:Add("cast", "Cast bar pip")
		container:Add("line", "White line")
		return container:GetData()
	end, "What marks your skill on the tooltip bar.")
